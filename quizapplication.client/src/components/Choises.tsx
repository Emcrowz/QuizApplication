...
import { ChoisesAnswerButton } from "./SubmitAnswersButton";
...
export const Choises: React.FC<ChoisesProps> = ({ question, dispatch, index, numberOfQuestions }) => {
    ...
    return (
        <form>
            {question.type === QuestionType.Single ? (
                ...
                <div><p>Question Type Unrecognized.</p></div>
            )}
            <ChoisesAnswerButton dispatch={dispatch} index={index} numberOfQuestions={numberOfQuestions} selectedAnswers={selectedAnswers} />
        </form>
    );
};